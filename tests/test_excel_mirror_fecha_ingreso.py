...
class TestBuscarFechaEnDataframe(unittest.TestCase):
    def test_happy_path(self):
        ...
        d, nom, err = buscar_fecha_ingreso_en_dataframe(df, "MARIA LOPEZ GARCIA")
    ...
    def test_no_na_n_a(self):
        ...
        d, nom, err = buscar_fecha_ingreso_en_dataframe(df, "Ana Ruiz")
        self.assertIsNone(err)
    ...
    def test_sin_coincidencia(self):
        ...
        d, nom, err = buscar_fecha_ingreso_en_dataframe(df, "No Existo")
        self.assertIsNone(d)
    ...
    def test_multiples_primera_sin_fecha_segunda_valida(self):
        ...
        d, nom, err = buscar_fecha_ingreso_en_dataframe(df, "Juan Pérez")
        self.assertIsNone(err)
    ...
    def test_coincidencia_sin_fecha_valida(self):
        ...
        d, nom, err = buscar_fecha_ingreso_en_dataframe(df, "Pedro")
        self.assertIsNone(d)
